<? 
$color_background="#ffffff";//"#E5F1FD";
$color_text_default="#404040";//PW: 616861
$color_text_headline="#009DBE";
$color_text_subline="#404040";
$color_content_border="#ffffff";
$color_dotted_line="#404040";
$color_warning="#FF0000";

$color_button_bg="#EB3192";
$color_button_font="#ffffff";
$color_botton_highlight_bg="#009DBE";
$color_botton_highlight_font="#ffffff";

$color_menu_hover="#009DBE";
$color_menu_font="#ffffff";
$color_menu_selected_bg="#009DBE";
$color_menu_selected_font="#ffffff";
$color_menu_border="#EB3192";

$color_breadcrums_bg="#ABDED5";
$color_kopf_fuﬂzeile="#404040";

$teaser_backgroundcolor="#ffffff";//"#f4f9ff";

$logo_path="/site_12_1/css/fs/logo_web.png";
$basislayout_seitenkopf="<img border='0' height='93' alt='".$site_description."' src='".$logo_path."' style='padding-bottom:10px'>";
?>
<style>
...
body{margin-left: 0px;margin-top: 8px;margin-right: 0px;margin-bottom: 8px; background-image:url(/site_12_1/css/fs/bg_familiespatz.jpg);}
...
.basislayout_contentcontainer1{float:left; width:950px !important;margin-right:12px;margin-left:20px;}
.basislayout_seitencontent_container{width:0px;float:left;}
...
.menubar_submenu{display:none; clear:both; min-height:17px; padding-bottom: 5px; padding-top: 5px; padding-left: 7px; vertical-align:central;background-color:<? echo $color_breadcrums_bg;?>;}
...
.teaser_clipping_width_hight{width:212px;height:100px;}
.teaser_spacer{width:7px;height:1px;float:left;}
...
#menu a {
	...
	display: block;
	border: 0px solid <? echo $color_button_bg; ?>;
