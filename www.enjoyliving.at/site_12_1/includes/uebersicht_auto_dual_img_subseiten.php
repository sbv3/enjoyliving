...
$img_needed=1;
//$number_menus=6; wird NICHT gebraucht, da alle siblings angezeigt werden sollen...
$containerwidth="295px"; //312 f den kl single 
$teasercopycols=40;
$col_nr=2;
$teaser_select_type="sibling";
$truncate_length=100;
$display_include_pfad="$adminpath/site_12_1/menu_teaser_auto.php";
